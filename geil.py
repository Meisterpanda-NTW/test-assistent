...
if (!Recognition) {
    ...
    rec.onresult = (e) => {
        ...
        if (gehoert.includes("okay garmin") || gehoert.includes("alexa") || gehoert.includes("okay gar")) {
            ...
            if (gehoert.includes("hallo")) {
                ...
                antwortText = "Befehle lauten: Hallo, video speichern, traubenzucker, schule, episode 1, episode 4, beenden";
                boxFarbe = "#fff3cd";                
